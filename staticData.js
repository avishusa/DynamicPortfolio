const intros = [{
    ...
    "firstname" : "Avish",
    "lastname" : "Modi",
    "caption" : "I code to debug my life.",
...
const abouts =[
    {
        ...
        "description2": "While I am embarking on my journey,I am acquiring the knowledge in cloud platforms like AWS, DevOps practices, Docker containerization, and the exciting world of microservices architecture. If you are seeking a passionate and driven entry-level Full Stack Developer, let's connect! Together, we can create innovative web experiences that leave a lasting impact. Get in touch and let's embark on this exciting journey of web development together.",
    },
    "skills"=[
        'JavaScript',
        'React',
